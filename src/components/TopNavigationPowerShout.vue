...
<template>
  <div class="flex items-center justify-between">
    ...
    <div class="w-1/5 flex justify-start items-center h-6">
        <div>
          <router-link to='/powershouthours'>
          <svg class="w-6 inline-flex items-center" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
          </svg>
        </router-link>
        </div>
        <div> <router-link to='/powershouthours'><h3 class="inline-flex">Back</h3></router-link></div>
    </div>
    ...
    <router-link to="/" class=" h-6 mr-4">
      <h3 class="w-1/5 inline-flex">Cancel</h3>
    </router-link>
