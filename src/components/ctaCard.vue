    ...
    <div class="z-10 mx-4 pt-6 mob:fixed mob:bottom-6 desk:hidden">
      ...
      >
        <div
          id="powerShout"
          ref="powerShout"
          class="overflow-hidden flex flex-col bg-white w-full h-auto border shadow-lg"
        >
          <div
            class="flex justify-between items-center cursor:pointer w-full text-off-black border-b border-gray-300"
          >
          ...
          <div class="flex py-4">
            ...
            <div class="w-2/5 p-2">
              <div class="relative w-full ">
                <img
                  class="absolute w-32 z-10 -bottom-30"
                  :src="genesislogo"
                >
              </div>
            </div>
    ...
    <div class="z-10 pt-6 mob:hidden desk:fixed desk:bottom-6 desk:right-6">
      ...
      <div v-if="isGenesis">
        <div
          id="powerShout"
          ref="powerShout"
          class="flex bg-white w-full h-auto border shadow-lg"
        >
          <div class="px-8 py-6 flex">
            ...
            <div class="flex-1">
              ...
              <div class="mt-6">
                <button
                  ...
                  @click="eiqRegister()"
                >
                  <div class="font-medium z-2 inline-block z-10 cursor:pointer text-center bg-background p-2 px-8 shadow-lg text-white rounded-3xl">
                    Register for EIQ
                  </div>
                </button> 
              </div>
            ...
            <a
              class="md:absolute fixed z-10 right-4 top-10 cursor-pointer"
              @click="ctaToggle()"
            >
              <svg
                width="16"
