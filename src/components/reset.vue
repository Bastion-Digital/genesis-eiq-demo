<template>
  <!-- Reset Button -->
  <div class="way-above">
    <div class="z-10 pt-6 top-4 right-6 mob:fixed desk:hidden">
      <!-- Mobile -->
      <button target="_BLANK" @click="resetPagesViews()">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
    ...
    <div
      class="z-10 pt-6 top-4 right-12 mob:hidden desk:fixed text-white underline"
    >
      <!-- Mobile -->
      <button target="_BLANK" @click="resetPagesViews()">
        <span class="underline">Reset guided tour</span>
      </button>
    </div>
  </div>
