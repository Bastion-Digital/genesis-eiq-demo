  ...
  <div class="bg-white h-full overflow-x-hidden overflow-y-hidden">
    <div>
      ...
      <calandarNotification
        ...
        class="absolute top-3 z-50 w-11/12"
      ...
      <div class="relative ">
        ...
        <div class="flex flex-col grey-gradient  pt-8 pb-12 text-black">
          ...
          <div
            class="-ml-2 text-8xl font-bold font-largecurrency flex justify-center md:w-internal w-100"
          >
            <img
              :src="powershout"
              class="inline-flex"
        ...
        <div class="relative">
          ...
          <router-link
            to="/powershouthours/booking"
            class="w-full flex justify-center -mt-6"
          >
            <div
              class="font-light z-2 inline-block z-10 cursor:pointer text-center bg-background p-2 px-8 shadow-lg text-white rounded-3xl"
            >
              Book a Power Shout
            </div>
          </router-link>
      ...
      <div
        class="relative flex-grow flex flex-col justify-center  bg-white p-4 text-black py-12 z-0"
      >
        <h3 class="font-medium">
          <b>Current Bookings</b> (0)
        </h3>
      </div>
      <div
        class="relative flex-grow flex flex-col waves-bg py-8 p-4 text-white z-10 h-80vh"
      >
        ...
        >
          <div class="flex items-center w-full ">
            <div class="inline-flex py-6 pr-8 border-r-2 border-dotted md:w-40">
              <div
                class="pr-4 flex text-4xl font-bold text-left font-largecurrency"
              >
                <img
                  :src="powershout"
                  style="width: 1.25em;"
...
export default {
  ...
  mounted() {
    this.$gtag.pageview({
      page_title: "Power Shout Hours",
      page_path: "/powershouthours",
    });
