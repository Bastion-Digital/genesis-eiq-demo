<template>
  <div class="bg-white h-full">
    <div v-if="showSpeechBubble" class="overlay absolute" />
    ...
    <div>
      ...
      <div
        class="flex-grow-0 text-left w-full top bottom left-1/2 gen-bg text-white"
      >
        <div v-if="showSpeechBubble">
          <div
            class="absolute mt-32 bg-white bubble text-black shadow rounded-xl p-6 way-above cursor-pointer"
          >
            <div class="absolute -bottom-2 triangle-up" style="left: 47.5%" />
            <p class="text-sm text-center">
              Monthly view shows seasonal usage trends. Click on July's bar to
        ...
        <TopNavigation
          ...
          link="/"
          @update:Conversion="doSomething"
        />

        <!-- Header -->
        <div class="sides pt-6">
          <div class="text-sm font-light">Electricity</div>
          <div class="flex mt-1">
            <div
              class="tracking-wide text-left text-2xl font-semibold font-largecurrency"
            >
              $
            </div>
            <div
              class="tracking-wide text-left text-5xl font-semibold font-largecurrency"
            >
              224
            </div>
            <div
      ...
      <div class="flex justify-around w-full text-gray-400 text-sm">
        ...
        <router-link to="/usage/daily" class="focus:outline-none tab">
          Daily
        </router-link>
        <router-link to="/usage/hourly" class="focus:outline-none tab">
          Hourly
        </router-link>
      </div>
      <div
        class="overflow-x-scroll relative flex-grow flex flex-col justify-center space-y-4 bg-white"
      >
        <!-- <img :src="hair" class="absolute front" style="width: 40px; left: 47.5%; margin-top: -2em; " /> -->
        <div
          class="absolute z-10 top-5 right-5 flex text-xs font-light align-center justify-center"
        >
          <div
